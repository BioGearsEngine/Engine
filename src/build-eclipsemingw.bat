...
IF EXIST ./cmake/eclipsemingw/%2 (
    cd cmake/eclipsemingw/%2
) ELSE (
    IF "%1"=="clean" GOTO EndClean
    
    ECHO CMake directory does not exist, run ant cmake -Denv=eclipsemingw in BioGears/src to generate the make files
    GOTO Error
)
